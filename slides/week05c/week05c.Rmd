...
* Average product of .orange[z-scores] for x and y
...
* As z-scores .orange[standardise] the variables, .orange[the original unit of measure doesn't matter]
]
---
...
.font150[
* Correlation coefficient is .orange[the average products of the z-score of _x_ and the z-score of _y_]

* Formally:

* $r_{x,y} = \frac{1}{n} \sum^{n-1}_{i=1} \big(\frac{x_i - \bar{x}}{S_x} \times \frac{y_i - \bar{y}}{S_y}\big)$
