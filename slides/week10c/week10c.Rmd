...
* .orange[Bayesian/subjective probability:] measure of one's subjective belief aboutthe likelihood of an event occurring.
]
---
...
--
.font150[
2) Professor Lee tells her students that nuclear war between Pakistan and India is unlikely.]
--
.font150[
...
Why 9 first? We can’t include the first digit in the formula _because 0 is not allowed_. .orange[Think about the problem first, then apply the formula!]
]
---
...
--
.font140[
* We cancel everything from $56 \times 55 .... \times 1$ in the nominator and $56!$ in the denominator
]
--
.font140[
