...
subtitle: "Regression with Uncertainty<html><div style='float:left'></div><hr color='#EB811B' size=1px width=800px></html>"
...
* .orange[Omitted variable bias:] when there is another factor that causes the dependent variable, but we didn't include them in our model
...
.font150[
* If you run a linear model with robust standard errors, the results are similar
